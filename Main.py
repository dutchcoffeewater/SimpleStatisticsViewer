...
with co1:
    st.subheader('👩 인구 통계')
    if st.button('총 인구'):
        st.session_state['recommendation_population'] = ['총 인구']
        st.success('이제 왼쪽 사이드바를 열고 👩 인구 통계를 선택하세요.')
    if st.button('서울특별시 인구 vs 경기도 인구'):
        st.session_state['recommendation_population'] = ['서울특별시 인구', '경기도 인구']
        st.success('이제 왼쪽 사이드바를 열고 👩 인구 통계를 선택하세요.')
    if st.button('광역시별 인구'):
        st.session_state['recommendation_population'] = ['광주광역시 인구', '대구광역시 인구',
            '대전광역시 인구', '부산광역시 인구', '울산광역시 인구', '인천광역시 인구']
        st.success('이제 왼쪽 사이드바를 열고 👩 인구 통계를 선택하세요.')
    if st.button('도별 인구'):
        st.session_state['recommendation_population'] = ['강원도 인구', '경기도 인구', '경상남도 인구',
